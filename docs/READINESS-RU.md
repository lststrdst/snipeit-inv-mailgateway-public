...
cutover не выполнен. Никакие службы на `192.0.2.202`, NAT или массовая GPO
...
|---|---|---:|---|
| Внутренние ПК | `192.0.2.202` | TCP 2443 | Разрешить firewall, NAT не нужен |
| Internet/UserGate | `192.0.2.202` | TCP 2443 | Пробросить только для ПК вне VPN |
...
`192.0.2.202`, снаружи — на публичный IP UserGate. Для FQDN нужен сертификат и
