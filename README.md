...
Я добавил [галерею писем OWNER CHANGE и REPORT](docs/examples/README.md)
с PNG-предпросмотром, исходным HTML и командой для повторной генерации.
Все данные в примерах вымышленные.
